...
; This script will set Ethernet connections as metered. To run this script, run the following command:
...
RegWrite, REG_DWORD, HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\NetworkList\DefaultMediaCost , Ethernet, 2
