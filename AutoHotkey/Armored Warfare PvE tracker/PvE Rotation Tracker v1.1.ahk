...
IniRead, OffsetMinVar, PvE Rotation Tracker data\Timing and Position data.ini, Offset, Minutes, 0	;Controls how many minutes the time is offset
Global OffsetSecVar := 0
IniRead, OffsetSecVar, PvE Rotation Tracker data\Timing and Position data.ini, Offset, Seconds, 0	;Controls how many seconds the time is offset
...
IfNotExist, PvE Rotation Tracker data\Missions List.txt	
{
	...
	FileAppend,`nPrometheus`nQuarterback`nRed Opossum`nRicochet`nRolling Thunder, PvE Rotation Tracker data\Missions List.txt
	FileAppend,`nSapphire`nScorpio`nSnake Bite`nSpearhead`nStarry Night, PvE Rotation Tracker data\Missions List.txt
	FileAppend,`nStormy Winter`nTsunami`nUmbrella`nWildfire`nZero Hour, PvE Rotation Tracker data\Missions List.txt
}
...
HelpButton:
	...
	MsgBox,,PvE Rotation Tracker v1.1 by Wiser Guy and XJDHDR, %MessageText%
return
